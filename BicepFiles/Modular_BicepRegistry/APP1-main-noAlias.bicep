...
module newSqlSrv 'br:acr10018.azurecr.io/modules/sqlsrv-module:v1' = if (createNewServer) {
  name: sqlServerName
  params: {
...
// Update the ACR uri according to your environment before deploying the bicep file
module fwRulesModule 'br:acr10018.azurecr.io/modules/sqlsrv-fwrule-module:v1' = {
  name: 'fwRules'
  params: {
...
// Update the ACR uri according to your environment before deploying the bicep file
module database 'br:acr10018.azurecr.io/modules/db-module:v1' = {
  name: databaseName
  params: {
